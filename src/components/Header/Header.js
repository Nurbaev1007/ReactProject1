            ...
            <div className="container">
                <nav className='header__nav'>
                    <div className='header__logo'>
                        <a href=""><svg width="118" height="26" viewBox="0 0 118 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g>
                            ...
                            <defs>
                                <clipPath id="clip0_1_205">
                                    <rect width="118" height="25.2992" fill="white"/>
                                </clipPath>
                            </defs>
                        </svg>
                        </a>
                    ...
                    <ul className='header__list'>
                        <li className="header__item"><a className='header__link' href="">Design</a></li>
                        <li className="header__item"><a className='header__link' href="">Health</a></li>
                        <li className="header__item"><a className='header__link' href="">Workout</a></li>
                        <li className="header__item"><a className='header__link' href="">Activity</a></li>
                        <li className="header__item"><a className='header__link' href="">Connect</a></li>
                    </ul>
                </nav>
            </div>
        </header>
